 ...
 * @author buimi
 */
public class Bai1StaffList extends javax.swing.JFrame {

    /**
     * Creates new form Bai1StaffList
     */
    public Bai1StaffList() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Bai1StaffList.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Bai1StaffList().setVisible(true);
            }
        });
    }
